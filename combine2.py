...
def combine_data(*args):
    ...
    result_data=np.ndarray(shape=(int(minlen*(l/2)),64,4))
    ...
    #test_data=result_data[train_len:train_len+int(0.20*total_len),:,:]
    #test_data_y=result_data_y[train_len:train_len+int(0.20*total_len)]
    test_data = result_data[train_len:total_len-100,:,:]
    test_data_y = result_data_y[train_len:total_len-100]
    #valid_data=result_data[train_len+int(0.20*total_len):total_len-100,:,:]
    #valid_data_y=result_data_y[train_len+int(0.20*total_len):total_len-100]
